...
if(isset($_POST['btnok']))
{
    ...
    $collection1=$con->Suppliers->supp_products;
    
    $show=$collection1->updateOne(['_id'=>$objectid],['$set'=>['ProductName'=>$pname,'Quantity'=>$quantity,'Price'=>$price,'Description'=>$desc]]);
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    <li>
                        <a href="index3.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-house"></span>
                            <span class="mtext">Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="productmng.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-table"></span>
                            <span class="mtext">Product Mng</span>
                        </a>
                    </li>
                    <li>
                        <a href="Ordermang.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-table"></span>
                            <span class="mtext">Order Mng</span>
                        </a>
                    </li>
                    <li>
                        <a href="productsuppliersglobal.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-table"></span>
            ...
            <div class="min-height-200px">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="index3.html">Product Mng</a>
                                    </li>
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-blue h4">Fill up form carefully..</h4>
                        ...
                        <?php
                            ...
                            $show=$collection->findOne(['_id'=>$objectid])

                        ?>
                        <form action="editproduct.php?sujal=<?php echo $id ?>" method="post">
                            <div class="form-group">
                                <label>Product Name</label>
                                <input class="form-control" type="text" value="<?php echo $show->ProductName; ?>" name="pname" />
                            </div>
                            <div>
                                <label>Quantity in kg </label>
                                <input class="form-control" value="<?php echo $show->Quantity; ?>" name="quantity" type="number" />
                            </div>
                            <div class="form-group">
                                <label>Price per *Kg</label>
                                <input class="form-control" value="<?php echo $show->Price; ?>" name="price" type="number" />
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea class="form-control" name="desc"><?php echo $show->Description; ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <input class="btn btn-success" type="Submit" name="btnok" value="Update.." />
