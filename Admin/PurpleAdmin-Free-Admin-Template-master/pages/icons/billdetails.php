...
<head>
    <style>
        ...
        #custom {
            height: auto;
            width: 400px;
            box-shadow: 10px 10px 20px rgb(103, 103, 212);
            border-radius: 5%;
            padding-top: 30px;
                        ...
                        <div class="col-lg-12 grid-margin">
                            <div class="card">
                                <div id="s">
                                                       ...
                                                       $coll1=$con1->admin->Bill;
                                                       $show1=$coll1->find([]);
                                                       foreach($show1 as $doc1)
                                                       {
                                                        echo "<a id='a' href='billdisp.php?bid=$doc1->_id'><div id='billdisp'>
                                                            <h4>$doc1->ProductName</h4>
                                                            <h6>$doc1->Placed_on</h6>
                                                            </div></a>
                                                        ";
                                                       }
