                            ...
                            <div class="card">
                                <div class="card-body">
                                   ...
                                   if(isset($_POST['btnok']))
                                   {
                                    ...
                                    $show=$collection->insertOne(['Productname'=>$name,'Price'=>$price,'Quantity'=>$qty]);
                                   }
                                   ?>
                                    <div class="row icons-list">
                                        <div class="col-12 grid-margin stretch-card">
                                            <div class="card">
                                              <div class="card-body">
                                                <h4 class="card-title">Adding Raw Material</h4>
                                                <p class="card-description"> Carefully Fillup Form... </p>
                                                <form class="forms-sample" action="rmadd.php" method="post">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <input type="text" name="qty" class="form-control" id="exampleInputEmail3" placeholder="In kg">
                                                  </div>
                                                 
                                                  
                                                  <input type="submit" name="btnok" value="ADD.." class="btn btn-gradient-primary me-2"/>
