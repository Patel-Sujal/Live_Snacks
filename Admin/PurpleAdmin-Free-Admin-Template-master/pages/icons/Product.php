                                ...
                                <div class="card-body">
                                    <div class="row icons-list">
                                        <div class="template-demo mt-2">
                                            <a href="addproduct.php"><input type="button" class="btn btn-outline-primary btn-icon-text"  class="mdi mdi-file-check btn-icon-prepend" value= "Add New" /></a>
                                                ...
                                                <table class="table table-striped">
                                                  ...
                                                  <tbody>
                                                    <?php
                                                        ...
                                                        {
                                                            $dele=$_GET['ID'];
                                                            $ob=new MOngoDB\BSON\ObjectId($dele);
                                                            $coll=$con->admin->Products;
                                                            $coll->deleteOne(['_id'=>$ob]);
                                                        }
                                                        ...
                                                        foreach($show as $doc)
                                                        {
                                                          ...
                                                          <td>
                                                                ...
                                                                <a href='updateproduct.php?id=$doc->_id' ><i class='mdi mdi-lead-pencil'></i></a> 
                                                                <a href='Product.php?ID=$doc->_id' ><i class='mdi mdi-close-circle'></i></a>
