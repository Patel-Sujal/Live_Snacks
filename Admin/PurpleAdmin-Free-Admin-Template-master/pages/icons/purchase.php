...
if(isset($_GET['Id']))
{
    ...
    $price=$_POST['Price1'];
    require "../../../../vendor/autoload.php";
    $connection2=new MongoDB\Client;
    $collection2=$connection2->admin->cart;
    $collection2->insertOne(['Productid'=>$Id,'Quantity'=>$qty]);    
}
                                ...
                                <div class="card-body">
                                    <div class="row icons-list">
                                        <div id='s'>
                                                ...
                                                require "../../../../vendor/autoload.php";
                                                $connection3=new MongoDB\Client;
                                                        $collection3=$connection3->admin->cart;
                                                        //$ob=new MongoDB\BSON\ObjectId($id);
                                                        $show1=$collection3->find([]);
                                                   ...
                                                   foreach($show as $doc)
                                                   {
                                                    ...
                                                    <div>
                                                        <div id='box'>
                                                            <a href='rawmaterialdetail.php?id=$id'>
                                                                <img id='img' src='Tomato_je.jpg'</img>
                                                            </a>
                                                        </div>
                                                        <div id='d'>
                                                            <center>
                                                            ...
                                                            <hr>
                                                            &nbsp;&nbsp;<a  $addtocart href='cart.php?Id=$id'><img title='Add to cart' height='40px' width='45px'
                                                            src='adtocart.jpeg' /></a>
                                                            <a  $gotocart href='gotocart.php?Id=$id'><img title='Add to cart' height='40px' width='45px'
                                                            src='gotocartt.jpeg' /></a>
                                                            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<a href='buynow.php?Id=$id'> <img title='Buynow'
