                                ...
                                <div class="card-body">
                                    <div class="row icons-list">
                                        <div class="col-lg-12 grid-margin stretch-card">
                                            <div class="card">
                                               <a href="rmadd.php"> <button type="button" class="btn btn-gradient-dark btn-icon-text"> Add <i
                                                    class="mdi mdi-file-check btn-icon-append"></i> </button></a>
                                              <div class="card-body">
                                                ...
                                                <table class="table table-bordered">
                                                  ...
                                                  if(isset($_GET['id']))
                                                  {
                                                    ...
                                                    $coll=$con->admin->RawMaterial;
                                                    $show1=$coll->deleteOne(['_id'=>$obj]);
                                                  }
                                                  ...
                                                  {$count=$count+1;
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td><a href='Rawmaterial.php?id=$doc->_id' ><i class='mdi mdi-close-circle'></i></a>
                                                        <a href='rmupdate.php?id=$doc->_id' ><i class='mdi mdi-lead-pencil'></i></a>
                                                    </td>
                                                    </tr>";
