            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="Product.php">Back</a></li>
                    ...
                    <?php
                        ...
                        if(isset($_POST['btnok']))
                        {
                            ...
                            $show = $collection->insertOne(['Productname'=>$pname,'Quantity'=>$quantity,'Price'=>$price,'Description'=>$desc]);
                        }
                                              ...
                                              <div class="card-body">
                                                ...
                                                <form class="forms-sample" action="addproduct.php" method="post">
                                                  <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputName1" name="pname" placeholder="Name">
                                                  </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="exampleInputName1" name="desc" placeholder="Description"></textarea>
                                                  </div>
                                                  <div class="form-group">
                                                    <label for="exampleInputEmail3">Quantity</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail3" name="quantity" placeholder="Email">
                                                  </div>
                                                  ...
                                                  <input name="btnok" value="Submit" type="submit" class="btn btn-gradient-primary me-2"/>
