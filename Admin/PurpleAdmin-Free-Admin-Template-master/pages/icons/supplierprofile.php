...
if(isset($_GET['user']))
{
    ...
    $c=$connection->Suppliers->supp_products;
    $c->deleteMany(['User'=>$user]);
}
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">R.M.</li>
                        </ol>
                        </nav>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <a href="addsupplier.php"><button type="button" class="btn btn-gradient-dark btn-icon-text"> Add <i class="mdi mdi-file-check btn-icon-append"></i>
                                    </button></a>
                                              ...
                                              <div class="card-body">
                                                ...
                                                <table class="table table-striped">
                                                  ...
                                                  foreach($show as $doc)
                                                  {
                                                    ...
                                                    <td> $doc->Phoneno </td>
                                                    <td> <a href='supplierprofile.php?user=$doc->Username'><i class='mdi mdi-close-octagon' title='delete'></i></a>
                                                      <a href='supplierupdate.php?user=$doc->Username' ><i class='mdi mdi-lead-pencil' title='Edit'></i></a>
                                                      <a href='supplierdetailedprofile.php?use=$doc->Username'><i class='mdi mdi-account' title='View account'></i> 
                                                      </td>
                                                  </tr>";
                                                  }
