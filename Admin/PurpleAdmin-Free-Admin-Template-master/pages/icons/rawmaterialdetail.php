            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="purchase.php">Back</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Purchase <R class="M"></R></li>
                        </ol>
                        </nav>
                    </div>
                        ...
                        <div class="row icons-list">
                           ...
                           <tr>
                                    ...
                                    <tr>
                                        <td>Product-Name :</td>
                                        <td>  </td>
                                        <td><u>$show->ProductName</u></td>

                                    </tr>
                                    <tr>
                                        <td>Quantity :</td>
                                        <td>  </td>
                                        <td><u>$show->Quantity kg</u></td>

                                    </tr>
                                    <tr>
                                        <td>Price :</td>
                                        <td>  </td>
                                        <td><u>$show->Price per kg</u></td>

                                    </tr>
                                    <tr>
                                        <td>Description :</td>
                                        <td>  </td>
                                        <td><u>$show->Description</u></td>
