                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Supplier Profiles</li>
                        </ol>
                        </nav>
                    </div>
                            ...
                            <div class='circle-container'>
                               ...
                               <table>
                                    <tr>
                                        <td>Full-name :</td>
                                        <td>  </td>
                                        <td><u>$show->Fullname</u></td>

                                    </tr>
                                    <tr>
                                        <td>Password :</td>
                                        <td>  </td>
                                        <td><u>$show->password</u></td>

                                    </tr>
                                    <tr>
                                        <td>Contact number :</td>
                                        <td>  </td>
                                        <td><u>$show->Phoneno</u></td>

                                    </tr>
                                    <tr>
                                        <td>Shopname :</td>
                                        <td>  </td>
                                        <td><u>$show->Shopname</u></td>

                                    </tr>
                                    <tr>
                                    <td>Address :</td>
                                    <td>  </td>
                                    <td><u>$show->Address</u></td>

                                </tr>
                                <tr>
                                <td>Email-ID :</td>
                                <td>  </td>
                                <td><u>$show->email</u></td>
