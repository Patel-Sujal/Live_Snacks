...
foreach($show as $doc)
{
    ...
    <div>
        <div id='box'>
            <a href='#'>
                <img id='img' src='s.jpg'></img></a>
        </div>
        <div id='d'>
            <center>
                <h4><u>$doc->ProductName </u></h4>
                <h5>₹$doc->Price per*kg</h5>
            </center>
            <hr>
            &nbsp;&nbsp;<img title='Add to cart' height='40px' width='45px'
                src='addtocart.png'>
            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <img title='Buynow'
                height='50px' width='50px' src='buynow.png'>
